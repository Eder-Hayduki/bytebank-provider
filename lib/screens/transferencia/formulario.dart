...
class FormularioTransferencia extends StatelessWidget {
  ...
  void _criaTransferencia(BuildContext context) {
    ...
    final transferenciaValida = _validaTransferencia(context, numeroConta,
        valor);
    if (transferenciaValida) {
      final novaTransferencia = Transferencia(0, valor!, numeroConta!);
  ...
  _validaTransferencia(context, numeroConta, valor) {
    ...
    final _saldoSuficiente = (valor <= Provider.of<Saldo>(context, listen:
    false).valor);
